...
function add(){
    ...
    scheduleHTML += "</select><label id=\"labelloc"+amt+"\">Location</label><input list=\"dataloc" +amt+ "\" name=\"dataloc" +amt+ "\" id=\"location" +amt+ "\"><datalist id=\"dataloc"+amt+"\">";
    for (let i = 0; i < locations.length; i++){
        scheduleHTML += "<option>";
        scheduleHTML += locations[i];
        scheduleHTML += "</option>";
    }
    scheduleHTML += "</datalist><br id=\"lb"+amt+"\">";
    scheduleAmt++;
